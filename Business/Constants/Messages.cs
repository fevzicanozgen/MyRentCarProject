...
namespace Business.Constants
{
    public class Messages
    {
        ...
        public static string BrandUpdated = "The Brand Update";
        ...
        public static string ColorUptaded = "Colors Updated";
